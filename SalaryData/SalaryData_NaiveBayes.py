...
salary_train = pd.read_csv("C:/Training/Analytics/Naive_Bayes/SalaryData/SalaryData_Train.csv")
salary_test = pd.read_csv("C:/Training/Analytics/Naive_Bayes/SalaryData/SalaryData_Test.csv")
